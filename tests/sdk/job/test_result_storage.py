...
def test_for_job(result_storage):
    ...
    """
    with patch('sdk.sdk.job_context.result_storage.ResultStorage') as mock_result_storage:
        new_storage = result_storage.for_job("new_job")

        mock_result_storage.assert_called_once_with(redis_host="redis://localhost:6379", redis_port=None, prefix="new_job")
