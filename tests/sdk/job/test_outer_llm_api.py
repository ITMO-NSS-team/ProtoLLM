...
from protollm.sdk.models.job_context_models import PromptModel, ResponseModel, ChatCompletionModel, \
...
@pytest.fixture
def mock_openai():
    with patch('protollm.sdk.jobs.outer_llm_api.OpenAI') as mock_openai:
