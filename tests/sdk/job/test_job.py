...
from protollm.sdk.celery.job import (
    LLMAPIJob, TextEmbedderJob, ResultStorageJob, VectorDBJob
)
from protollm.sdk.models.job_context_models import LLMResponse, TextEmbedderResponse
...
@pytest.mark.skip(reason="We haven't local vector DB")
