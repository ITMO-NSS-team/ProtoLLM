...
import pika
import pytest
from protollm.sdk.sdk.sdk.models.job_context_models import (ChatCompletionModel, PromptMeta, ChatCompletionUnit,
...
def rabbitmq_connection(test_local_config):
    ...
    connection = pika.BlockingConnection(
        pika.ConnectionParameters(host=test_local_config.rabbit_host,
