...
from protollm.docs_processing.parsing.parsers import WordDocumentParser, ParsingScheme, DocType
...
class WordDocumentLoader(BaseLoader):
    ...
    def __init__(
        ...
        self.parser = WordDocumentParser(parsing_scheme, extract_images, extract_tables, parse_formulas,
    ...
    def lazy_load(
        ...
        if self.byte_content is None:
            ...
            blob = Blob.from_data(self.byte_content, path=self.file_path, mime_type=self._doc_type)
