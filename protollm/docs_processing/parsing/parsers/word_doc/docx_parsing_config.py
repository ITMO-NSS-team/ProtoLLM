...
from protollm.docs_processing.parsing.parsers.word_doc.xml.utilities import (_get_omml2mml_transformation,
                                                                    _get_mml2tex_transformation)


class DocxParsingConfig:
    def __init__(self, document: Document, extract_images: bool = False, parse_formulas: bool = False):
