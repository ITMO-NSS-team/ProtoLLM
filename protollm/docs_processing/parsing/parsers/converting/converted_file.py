...
from protollm.docs_processing.parsing.parsers.entities import ConvertingDocType
from protollm.docs_processing.parsing.parsers.converting.converting import _convert_with_soffice


@contextmanager
def converted_file(stream,
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        _convert_with_soffice(filename=tmp_file_path, output_directory=tmp_dir,
                              target_doc_type=target_doc_type, timeout=timeout)
