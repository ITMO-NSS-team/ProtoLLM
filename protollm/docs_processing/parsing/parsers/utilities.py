...
HEADING_KEYWORDS = ['предисловие', 'содержание', 'оглавление', 'введение', 'лист согласований']
CONTENTS_KEYWORDS = ['содержание', 'оглавление', 'лист согласований']
HEADING_STOP_LIST = ['утверждаю']
# HEADING_STOP_LIST = ['утверждаю', 'открытое акционерное общество "татнефть"', '____']
TITLE_KEYWORDS = ['альметьевск', 'казань']
