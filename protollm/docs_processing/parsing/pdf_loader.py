...
from protollm.docs_processing.parsing.parsers import PDFParser, ParsingScheme, DocType
...
class PDFLoader(BaseLoader):
    ...
    def __init__(
        ...
        self.parser = PDFParser(parsing_scheme, extract_images, extract_tables, parse_formulas,
                                remove_service_info)
    ...
    def lazy_load(
        ...
        if self.byte_content is None:
            ...
            blob = Blob.from_data(self.byte_content, path=self.file_path, mime_type=DocType.pdf.value)
