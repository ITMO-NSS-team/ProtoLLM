...
class DivMetadataSentencesSplitter(TextSplitter):
    ...
    def _split_on_sentences_with_additional_metadata(self, documents: Iterable[Document]) -> List[Document]:
        splitted_docs = []
        for doc in documents:
            doc_metadata = doc.metadata
            doc_metadata['div'] = doc.page_content
            splitted_docs.extend([self._create_document(text, doc_metadata)
